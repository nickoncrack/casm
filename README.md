...
0x1000 | FF 11 00 00 10 30 00 00 00 00                jmp <main+0>
...
0x1028 | FF 02 00 00 00 00 00 00 00 01    <loop+1>    add a, 1
0x1032 | FF 04 00 00 00 00 00 00 00 0A    <loop+2>    cmp a, 10
0x103C | FF 07 00 00 10 06 00 00 00 00    <loop+3>    je <end+0>
0x1046 | FF 0B 00 00 10 18 00 00 00 00    <loop+4>    jl <loop+1>
0x1050 | FF 03 00 00 00 00 00 00 00 00    <main+0>    mov a, 0
0x105A | FF 03 01 00 00 00 00 00 00 0A    <main+1>    mov b, 10
0x1064 | 00 03 04 00 00 00 01 00 00 00    <main+2>    mov r0, b
